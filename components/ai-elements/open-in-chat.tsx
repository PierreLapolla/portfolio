...
export const OpenInChatGPT = (props: OpenInChatGPTProps) => {
    ...
    return (
        <DropdownMenuItem {...props}
                          render={<a className="flex items-center gap-2" href={providers.chatgpt.createUrl(query)}
                                     rel="noopener" target="_blank"/>} nativeButton={false}><span
            className="shrink-0">{providers.chatgpt.icon}</span><span
            className="flex-1">{providers.chatgpt.title}</span><ExternalLinkIcon
            className="size-4 shrink-0"/></DropdownMenuItem>
    );
};
...
export const OpenInClaude = (props: OpenInClaudeProps) => {
    ...
    return (
        <DropdownMenuItem {...props}
                          render={<a className="flex items-center gap-2" href={providers.claude.createUrl(query)}
                                     rel="noopener" target="_blank"/>} nativeButton={false}><span
            className="shrink-0">{providers.claude.icon}</span><span
            className="flex-1">{providers.claude.title}</span><ExternalLinkIcon
            className="size-4 shrink-0"/></DropdownMenuItem>
    );
};
...
export const OpenInT3 = (props: OpenInT3Props) => {
    const {query} = useOpenInContext();
    return (
        <DropdownMenuItem {...props} render={<a className="flex items-center gap-2" href={providers.t3.createUrl(query)}
                                                rel="noopener" target="_blank"/>} nativeButton={false}><span
            className="shrink-0">{providers.t3.icon}</span><span
            className="flex-1">{providers.t3.title}</span><ExternalLinkIcon
            className="size-4 shrink-0"/></DropdownMenuItem>
    );
};
...
export const OpenInScira = (props: OpenInSciraProps) => {
    ...
    return (
        <DropdownMenuItem {...props}
                          render={<a className="flex items-center gap-2" href={providers.scira.createUrl(query)}
                                     rel="noopener" target="_blank"/>} nativeButton={false}><span
            className="shrink-0">{providers.scira.icon}</span><span
            className="flex-1">{providers.scira.title}</span><ExternalLinkIcon
            className="size-4 shrink-0"/></DropdownMenuItem>
    );
};
...
export const OpenInv0 = (props: OpenInv0Props) => {
    const {query} = useOpenInContext();
    return (
        <DropdownMenuItem {...props} render={<a className="flex items-center gap-2" href={providers.v0.createUrl(query)}
                                                rel="noopener" target="_blank"/>} nativeButton={false}><span
            className="shrink-0">{providers.v0.icon}</span><span
            className="flex-1">{providers.v0.title}</span><ExternalLinkIcon
            className="size-4 shrink-0"/></DropdownMenuItem>
    );
};
...
export const OpenInCursor = (props: OpenInCursorProps) => {
    ...
    return (
        <DropdownMenuItem {...props}
                          render={<a className="flex items-center gap-2" href={providers.cursor.createUrl(query)}
                                     rel="noopener" target="_blank"/>} nativeButton={false}><span
            className="shrink-0">{providers.cursor.icon}</span><span
            className="flex-1">{providers.cursor.title}</span><ExternalLinkIcon
            className="size-4 shrink-0"/></DropdownMenuItem>
    );
};
